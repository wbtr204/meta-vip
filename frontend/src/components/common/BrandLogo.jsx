...
const BrandLogo = ({
    ...
    return (
        <div className={`flex items-center gap-2 ${className}`}>
            <div
                className={`shrink-0 ${sizeClasses[size] || sizeClasses.md} bg-slate-900 dark:bg-white text-white dark:text-slate-900 flex items-center justify-center shadow-sm ring-1 ring-white/10 dark:ring-slate-900/10 transition-all`}
                aria-hidden="true"
            >
